        ...
        if (isset($_POST['action']) && $_POST['action'] == 'et_ajax_ai'){
            if ( isset($_POST['data']) && !empty($_POST['data']) ){
                ...
                if (
	                ...
	                if (in_array($this->settings['api_model'], array('gpt-4', 'gpt-3.5-turbo', 'gpt-4-1106-preview'))){
    ...
    private function rewrite_data(){
        ...
        if ($response) {
            if (
	            ...
	            in_array($this->settings['api_model'], array('gpt-4', 'gpt-3.5-turbo', 'gpt-4-1106-preview'))
	            && isset($response['choices'])
	            && isset($response['choices'][0])
