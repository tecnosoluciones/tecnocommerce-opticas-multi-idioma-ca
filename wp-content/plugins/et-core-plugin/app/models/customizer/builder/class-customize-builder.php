		...
		switch ( $this->post['type'] ) {
			...
			case 'save':
				...
				if ( $this->post['builder'] == 'header' ) {
					...
					// Fonts options
					if ( $this->post['options']['single_product_button_fonts_et-desktop'] )
					...
					if ( $this->post['options']['product_breadcrumbs_fonts_et-desktop'] )
					...
					if ( $this->post['options']['product_breadcrumbs_return_to_previous_fonts_et-desktop'] )
					...
					if ( $this->post['options']['product_breadcrumbs_product_title_fonts_et-desktop'] )
					...
					if ( $this->post['options']['product_add_to_cart_fonts_et-desktop'] )
					...
					if ( $this->post['options']['product_tabs_navigation_fonts_et-desktop'] )
					...
					if ( $this->post['options']['product_title_fonts_et-desktop'] )
					...
					if ( $this->post['options']['single_product_widget_area_1_title_fonts_et-desktop'] )
					...
					if ( $this->post['options']['request_quote_button_fonts_et-desktop'] )
