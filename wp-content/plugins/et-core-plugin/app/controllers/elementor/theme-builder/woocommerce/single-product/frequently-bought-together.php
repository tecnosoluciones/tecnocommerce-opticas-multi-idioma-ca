...
class Frequently_Bought_Together extends \Elementor\Widget_Base {
	...
	public function get_icon() {
        return 'eight_theme-elementor-icon et-elementor-product-frequently-bought-together';
	}
	...
	public function get_custom_help_url() {
		return 'https://xstore.helpscoutdocs.com/article/132-frequently-bought-together';
	}
        ...
        $this->add_control(
            ...
            [
                'raw' => sprintf(esc_html__('This widget displays products set in %s settings.', 'xstore-core'),
                    '<a href="https://xstore.helpscoutdocs.com/article/132-frequently-bought-together" rel="nofollow" target="_blank">' . esc_html__('Bought together', 'xstore-core') . '</a>'),
