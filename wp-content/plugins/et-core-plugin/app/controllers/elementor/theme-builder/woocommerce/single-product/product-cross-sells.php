...
class Product_Cross_Sells extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        $cross_sells = wc_products_array_orderby( array_filter( array_map( 'wc_get_product', $product->get_cross_sell_ids() ), 'wc_products_array_filter_visible' ), $settings['orderby'], $settings['order'] );
