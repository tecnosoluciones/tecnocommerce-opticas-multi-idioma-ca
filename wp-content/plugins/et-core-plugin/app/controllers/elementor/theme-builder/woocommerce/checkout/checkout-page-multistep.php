    ...
    public function add_sections_style($class) {
        ...
        $class->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .etheme-checkout-page-prev-step',
            ]
        );
        ...
        $class->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .etheme-checkout-page-prev-step' => 'fill: {{VALUE}}; color: {{VALUE}}; --loader-side-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $class->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .etheme-checkout-page-prev-step' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $class->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .etheme-checkout-page-prev-step:hover, {{WRAPPER}} .etheme-checkout-page-prev-step:focus' => 'color: {{VALUE}}; --loader-side-color: {{VALUE}};',
                    '{{WRAPPER}} .etheme-checkout-page-prev-step:hover svg, {{WRAPPER}} .etheme-checkout-page-prev-step:focus svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $class->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .etheme-checkout-page-prev-step:hover, {{WRAPPER}} .etheme-checkout-page-prev-step:focus' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $class->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .etheme-checkout-page-prev-step:hover, {{WRAPPER}} .etheme-checkout-page-prev-step:focus' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $class->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .etheme-checkout-page-prev-step, {{WRAPPER}} .etheme-checkout-page-prev-step.button',
                'separator' => 'before',
            ]
        );
        ...
        $class->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .etheme-checkout-page-prev-step' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $class->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .etheme-checkout-page-prev-step' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
