...
class Product_Images extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'eight_theme-elementor-icon et-elementor-product-image';
	}
...
//        );
	...
	protected function render() {
        ...
        if ( in_array($settings['type'], array('one_image', 'double_image')) && wp_is_mobile() )
