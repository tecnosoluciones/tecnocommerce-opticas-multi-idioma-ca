...
//		$this->log_imported_data('multiples', $option);
	...
	public function import_elementor_sections() {
		...
		if (
			isset($this->versions[ $this->version ])
			&& isset($this->versions[ $this->version ]['to_import'])
			&& isset($this->versions[ $this->version ]['to_import']['elementor_sections_type'])
		){
			$type = $this->versions[ $this->version ]['to_import']['elementor_sections_type'];
		}
