...
//				'mobile_default' => 2,
    ...
    public static function elementor_off_canvas($class, $settings, $button = '', $content = '') {
        ?>
     ...
     * @return array
     */
    public static function get_saved_content_list($with_global_widget = true) {
        $content_list = [
            'custom'   => __( 'Custom', 'xstore-core' ),
            'saved_template' => __( 'Saved Template', 'xstore-core' ),
        ];

        if ( $with_global_widget && defined( 'ELEMENTOR_PRO_VERSION' ) ) {
