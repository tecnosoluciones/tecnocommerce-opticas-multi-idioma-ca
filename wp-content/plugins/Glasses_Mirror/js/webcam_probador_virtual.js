jQuery(document).ready(function ($) {
    var urlx= probador_virtual.url;
    var urltofile= probador_virtual.urltofile;
    var urltofile1=probador_virtual.urltofile1;
    var urltofile2=probador_virtual.urltofile2;
    (function($, window, document, undefined) {
        // Detect XMLHttpRequest support
        $.support.xhrUpload =  !!(window.XMLHttpRequest && window.File && window.FileReader && window.FileList && window.Blob && window.FormData);
        // Detect getUserMedia support
        $.support.getUserMedia = !!(navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia);
        // Detect Jcrop support
        $.support.Jcrop = !!$.Jcrop;
        // Detect JPEGCam support
        $.support.Webcam = !!window.Webcam;
        var pluginName = 'imgPicker',
    ...
    jQuery(function() {
        ...
        jQuery('#avatarModal').imgPicker({
            ...
            deleteComplete: function() {
                jQuery('#Backgroundimg').attr('src',urltofile1);
                this.modal('hide');
            },
            // Crop success callback
            cropSuccess: function(image) {
                jQuery('#Backgroundimg').attr('src',urltofile2+image.versions.avatar.url + time());
                this.modal('hide');
            },
