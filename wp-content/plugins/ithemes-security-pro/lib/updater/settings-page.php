...
?>
	<div class="solidwp-licensing-page-header">
		<img src="<?php echo $this->path_url . '/images/solid_wp_logo.svg' ?>" />
	</div>
...
//								$remaining .= ' <a class="button-secondary upgrade">' . __( 'Upgrade', 'it-l10n-ithemes-security-pro' ) . '</a>';
						...
						<tr class="<?php echo $class; ?>">
							...
							<td class="mobile-hidden"><?php echo $data['user']; ?></td>
			...
			<table class="ithemes-updater-listing widefat">
				...
				<tbody>
					...
					<?php foreach ( $patchstack['sites'] as $site ) : ?>
						...
						<tr class="<?php echo $class; ?>">
							<th class="check-column" scope="row">
								<label class="screen-reader-text" for="<?php echo $check_id; ?>"><?php printf( __( 'Select %s' ), $site ); ?></label>
								<label for="<?php echo $check_id; ?>">
									<input id="<?php echo $check_id ?>" name="patchstack_sites[]" value="<?php echo $site; ?>" type="checkbox"<?php echo $checked; ?>>
								</label>
							</th>
							<td>
								<label for="<?php echo $check_id; ?>"><?php echo $site; ?></label>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>
			...
			<form id="posts-filter" enctype="multipart/form-data" method="post" action="<?php echo $this->self_url; ?>">
				...
				<div id="ithemes-updater-settings">
					<div id="ithemes-updater-table-wrapper">
						...
						<p class="description ithemes-updater-description-warning secondary-description"><?php printf( __( 'Use this option if this site\'s primary URL has changed from <code>%1$s</code> to <code>%2$s</code>.', 'it-l10n-ithemes-security-pro' ), $site_url_from_server, $data['site_url'] ); ?></p>
