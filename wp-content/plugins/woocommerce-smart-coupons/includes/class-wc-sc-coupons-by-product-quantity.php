...
if ( ! class_exists( 'WC_SC_Coupons_By_Product_Quantity' ) ) {
	...
	class WC_SC_Coupons_By_Product_Quantity {
		 ...
		 * @return array
		 */
		public function cart_product_quantities( $cart_content = array() ) {
		 ...
		 * @return array
		 */
		public function cart_product_categories_quantities( $cart_content = array() ) {
			if ( empty( $cart_content ) ) {
				return $cart_content;
			}
			$categories_quantities = array();
			foreach ( $cart_content as $key => $cart_item ) {
				$wc_sc_product_source = ! empty( $cart_item['wc_sc_product_source'] ) ? $cart_item['wc_sc_product_source'] : '';
