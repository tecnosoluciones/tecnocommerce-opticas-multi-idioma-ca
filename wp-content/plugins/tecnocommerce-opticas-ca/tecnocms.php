<?php
/*
Plugin Name: TecnoCommerce | Ópticas con asistencia
...
$plugin_label = 'Tecno<strong>Commerce</strong> Ópticas<span style="font-size: 28px;color: #000"> | </span> <span>Con asistencia</span>';
