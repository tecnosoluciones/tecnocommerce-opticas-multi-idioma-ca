            ...
            if ( $activated ) {
                ...
                $options = array(
	                array(
		                ...
		                'description' => esc_html__('Choose the preferred AI model for enhanced customization and functionality within the XStore theme.', 'xstore'),
		                'type' => 'select',
		                'options'  => array(
			                'text-davinci-003' => esc_html__( 'Davinci 003', 'xstore' ),
			                'gpt-4-1106-preview'    => esc_html__( 'GPT-4 turbo', 'xstore'),
