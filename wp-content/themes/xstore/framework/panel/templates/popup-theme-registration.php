...
<div class="et_popup-theme-registration et_panel-popup-inner with-scroll">
    ...
    <div class="steps-block-content">
        <div class="popup-step step-1">
			...
			<?php if(!et_check_domain_pattern($domain)) : ?>
                <div class="et-message et-error staging-domain-error hidden">
                    ...
                    <p><?php echo sprintf(
							esc_html__('So, for example, if you choose the pattern %s or %s, your staging site URL would look like this: %s OR %s'),
							'<strong>"dev."</strong>',
							'<strong>"test."</strong>',
                    ...
                    <p><?php echo sprintf(esc_html__('You can find the full list of our patterns and detailed instructions on how to register XStore for [staging websites/ live website] in
                            %sOur Documentation Guide%s', 'xstore'), '<a href="https://xstore.helpscoutdocs.com/article/163-how-to-registerderegister-xstore-theme-livestaging-websites" target="_blank">', '</a>'); ?></p>
                </div>
			<?php else: ?>
        ...
        <div class="popup-step step-2 hidden">
            ...
            <div class="section-block step-1">
                ...
                <p class="section-text">
					<?php echo sprintf(__('<b>License Policy:</b> I understand that when I register the XStore theme, it\'s important to be aware of %s ThemeForest\'s license policy %s. Each valid license can be used for one project or domain ONLY.', 'xstore'),
            ...
            <div class="section-block step-2 invisible">
                ...
                <p class="section-text">
					<?php echo sprintf(__('<b>Data Storage Consent:</b> By clicking "Register," I agree to allow %s to store my purchase code and user data, ensuring a secure and efficient project management experience.', 'xstore'),
						'<a href="https://8theme.com/" target="_blank" rel="nofollow">8theme.com</a>'); ?>
                </p>
            </div>
        ...
        <div class="popup-step step-3 invisible hidden">
            ...
            <br/>
            <svg width="163" height="89" viewBox="0 0 468 258" fill="none" xmlns="http://www.w3.org/2000/svg">
