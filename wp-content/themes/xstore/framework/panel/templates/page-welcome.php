...
<div class="xstore-panel-grid-wrapper">
            ...
            <div class="xstore-panel-info-blocks<?php if ( !$xstore_branding_settings_inited ) echo ' one-col'; ?>">
                <div class="xstore-panel-info-block type-2">
                    <div>
                        ...
                        <p><?php echo !isset($settings['thank_you_text']) ? sprintf(esc_html__('Welcome, and thank you for purchasing %s! We hope you have a fantastic experience with our product and that it helps you create an outstanding online business!', 'xstore'), $settings['brand_label']) : $settings['thank_you_text']; ?></p>
                        <p>
                            ...
                            <span>
                                <a href="https://xstore.8theme.com/update-history/" target="_blank" rel="nofollow">
                                    <?php echo sprintf(esc_html__('What\'s new in %s v.9.2', 'xstore'), $settings['brand_label']); ?>
                                </a>
        ...
        <?php if ( !$xstore_branding_settings_inited ) : ?>
            <div class="xstore-panel-grid-item">
                <div class="main-features-slider" style="visibility: hidden; opacity: 0;">
                    <?php
                        for ($i=1; $i<=7; $i++) {
                            echo '<div class="slick-carousel-item"><a href="https://bit.ly/3hewHb7" rel="nofollow" target="_blank"><img src="' .esc_url( ETHEME_BASE_URI.'framework/panel/images/welcome/9.2-banner-'.$i.'.jpg' ) . '" alt="'.$settings['brand_label'] . ' 9.2 - ' . $i.'"></a></div>';
                        }
                    ?>
                </div>
                <br/>
        ...
        <?php
            $extended_links = array(
                'xstore' => array(
                        ...
                        'title' => sprintf(esc_html__('Buy %s License', 'xstore'), $settings['brand_label']),
                        'link' => 'https://1.envato.market/2rXmmA',
                        'description' => sprintf(esc_html__('Get more out of %s by adding another license for your next project.', 'xstore'), $settings['brand_label'])
                ),
            'wpml' => array(
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.9664 5.9832V0H0V11.9664H5.9832V5.9832H11.9664Z"></path>
                ...
                'link' => 'https://www.8theme.com/contact-us/',
...
wp_add_inline_script( 'etheme_admin_js', '
			jQuery(document).ready(function($) {
            	$("head").find("title").text("'.$settings['brand_label'].'");
		    });
		', 'after' );