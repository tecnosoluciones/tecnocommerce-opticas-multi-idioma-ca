...
<div class="popup-import-head">
	<img
		class="version-img lazyload lazyload-simple"
        src="<?php echo esc_html( ETHEME_BASE_URI . ETHEME_CODE ); ?>assets/images/placeholder-350x268.png"
        data-src="<?php echo apply_filters('etheme_protocol_url', ETHEME_BASE_URL . 'import/xstore-demos/' . esc_attr( $_POST['version'] ) . '/screenshot.jpg'); ?>"
